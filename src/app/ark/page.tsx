...
export const metadata: Metadata = {
  ...
  description:
    "Beställ egna DTF-tryckark i A4 eller A3 – ladda upp motiv, välj antal kopior så packar vi arket automatiskt. Pressa hemma med strykjärn eller värmepress. Gang sheet-tryck utan uppläggsavgifter.",
